module.exports = [
"[project]/node_modules/.pnpm/@fumari+json-schema-to-typescript@2.0.0/node_modules/@fumari/json-schema-to-typescript/dist/chunk-6FNC3XMI.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/.pnpm/@fumari+json-schema-to-typescript@2.0.0/node_modules/@fumari/json-schema-to-typescript/dist/chunk-HXIR7QLA.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@fumari+json-schema-to-typescript@2.0.0/node_modules/@fumari/json-schema-to-typescript/dist/chunk-6FNC3XMI.js [app-rsc] (ecmascript)");
;
...
function omit(obj, ...keys) {
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, obj);
...
"[project]/node_modules/.pnpm/@fumari+json-schema-to-typescript@2.0.0/node_modules/@fumari/json-schema-to-typescript/dist/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@fumari+json-schema-to-typescript@2.0.0/node_modules/@fumari/json-schema-to-typescript/dist/chunk-HXIR7QLA.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@fumari+json-schema-to-typescript@2.0.0/node_modules/@fumari/json-schema-to-typescript/dist/chunk-6FNC3XMI.js [app-rsc] (ecmascript)");
;
;
// src/types/AST.ts
...
function generateRawType(ast, options) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["log"])("generator", ast);
    if (hasStandaloneName(ast)) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toSafeString"])(ast.standaloneName);
    }
    switch(ast.type){
        case "ANY":
            return "any";
...
function generateStandaloneEnum(ast, options) {
    return (hasComment(ast) ? generateComment(ast.comment, ast.deprecated) + "\n" : "") + "export " + (options.enableConstEnums ? "const " : "") + `enum ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toSafeString"])(ast.standaloneName)} {
` + ast.params.map(({ ast: ast2, keyName })=>keyName + " = " + generateType(ast2, options)).join(",\n") + "\n}";
}
function generateStandaloneInterface(ast, options) {
    return (hasComment(ast) ? generateComment(ast.comment, ast.deprecated) + "\n" : "") + `export interface ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toSafeString"])(ast.standaloneName)} ` + (ast.superTypes.length > 0 ? `extends ${ast.superTypes.map((superType)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toSafeString"])(superType.standaloneName)).join(", ")} ` : "") + generateInterface(ast, options);
}
function generateStandaloneType(ast, options) {
    return (hasComment(ast) ? generateComment(ast.comment) + "\n" : "") + `export type ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toSafeString"])(ast.standaloneName)} = ${generateType((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["omit"])(ast, "standaloneName"), options)}`;
}
...
var matchers = {
    ...
    BOOLEAN (schema) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isCompound"])(schema) && typeof schema.default === "boolean") {
            return true;
        }
        return false;
    },
    ...
    NUMBER (schema) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isCompound"])(schema) && typeof schema.default === "number") {
            return true;
        }
        return false;
    },
    OBJECT (schema) {
        return schema.type === "object" && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isPlainObject"])(schema.additionalProperties) && !schema.allOf && !schema.anyOf && !schema.oneOf && !schema.patternProperties && !schema.properties && !schema.required;
    },
    ONE_OF (schema) {
    ...
    STRING (schema) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isCompound"])(schema) && typeof schema.default === "string") {
            return true;
        }
        return false;
    },
...
function applySchemaTyping(schema) {
    ...
    Object.assign(schema, {
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Types"]]: types
    });
    if (types.size === 1) {
        return;
    }
    const intersection = {
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Parent"]]: schema,
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Types"]]: /* @__PURE__ */ new Set([
            "ALL_OF"
        ]),
        $id: schema.$id,
    ...
    delete schema.title;
    Object.assign(schema, {
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Intersection"]]: intersection
    });
}
// src/normalizer.ts
...
rules.set("Transform id to $id", (schema, fileName)=>{
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isSchemaLike"])(schema)) {
        return;
    }
...
rules.set("Add an $id to anything that needs it", (schema, fileName, _options, _key, dereferencedPaths)=>{
    ...
    if (!schema.$id && !schema[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Parent"]]) {
        schema.$id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toSafeString"])(normalizeName(fileName));
        return;
    }
...
rules.set("Escape closing JSDoc comment", (schema)=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["escapeBlockComment"])(schema);
});
rules.set("Add JSDoc comments for minItems and maxItems", (schema)=>{
    ...
    if (commentsToAppend.length) {
        schema.description = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["appendToDescription"])(schema.description, ...commentsToAppend);
    }
});
...
function normalize(input, filename, options) {
    rules.forEach((rule)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["traverse"])(input.schema, (schema, key)=>rule(schema, filename, options, key, input.schemaToId)));
    return input.schema;
}
// src/optimizer.ts
    ...
    switch(ast.type){
        ...
        case "UNION":
            ...
            if (optimizedAST.params.some((_)=>_.type === "ANY")) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["log"])("optimizer", "[A, B, C, Any] -> Any", optimizedAST);
                return T_ANY;
            }
            if (optimizedAST.params.some((_)=>_.type === "UNKNOWN")) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["log"])("optimizer", "[A, B, C, Unknown] -> Unknown", optimizedAST);
                return T_UNKNOWN;
            }
...
function omitStandaloneName(ast) {
    switch(ast.type){
        case "ENUM":
            return ast;
        default:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadProps"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, ast), {
...
function parse(schema, options, keyName, processed = /* @__PURE__ */ new Map(), usedNames = /* @__PURE__ */ new Set()) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isPrimitive"])(schema)) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isBoolean"])(schema)) {
            return parseBooleanSchema(schema, keyName, options);
        }
        return parseLiteral(schema, keyName);
    }
    const intersection = schema[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Intersection"]];
    const types = schema[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Types"]];
    if (intersection) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["log"])("parser", "Types:", [
            ...types
    ...
    if (types.size === 1) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["log"])("parser", "Type:", type, "Input:", schema, "Output:", ast);
        return ast;
    }
...
function parseNonLiteral(schema, type, options, keyName, processed, usedNames) {
    const definitions = getDefinitions((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRootSchema"])(schema));
    ...
    switch(type){
        case "ALL_OF":
            {
                ...
                if (!hasNullable) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadProps"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, baseAst), {
                        type: "INTERSECTION",
                        params
                    });
                }
        ...
        case "ANY":
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadProps"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, options.unknownAny ? T_UNKNOWN : T_ANY), {
                comment: schema.description,
                deprecated: schema.deprecated,
                keyName,
                standaloneName: standaloneName(schema, keyNameFromDefinition, usedNames, options)
        ...
        case "UNION":
            return {
                ...
                params: schema.type.map((type2)=>{
                    const member = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadProps"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["omit"])(schema, "$id", "description", "title")), {
                        type: type2
                    });
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["maybeStripDefault"])(member);
...
function standaloneName(schema, keyNameFromDefinition, usedNames, options) {
    ...
    if (name) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateName"])(name, usedNames);
    }
}
...
function getDefinitions(schema, isSchema = true, processed = /* @__PURE__ */ new Set()) {
    ...
    if (Array.isArray(schema)) {
        result = schema.reduce((prev, cur)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, prev), getDefinitions(cur, false, processed)), {});
    } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isPlainObject"])(schema)) {
        result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, isSchema && hasDefinitions(schema) ? schema.$defs : {}), Object.keys(schema).reduce((prev, cur)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__spreadValues"])({}, prev), getDefinitions(schema[cur], false, processed)), {}));
    }
    cacheList.push([
        schema,
        result
...
function validate({ schema }, filename) {
    ...
    rules2.forEach((rule, ruleName)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["traverse"])(schema, (schema2, key)=>{
...
function link(schema, parent = null) {
    if (!Array.isArray(schema) && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isPlainObject"])(schema)) {
        return schema;
    }
    if (schema.hasOwnProperty(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Parent"])) {
        return schema;
    }
    if (schema) Object.assign(schema, {
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Parent"]]: parent
    });
    if (Array.isArray(schema)) {
...
function compileYamlFile(_0, _1) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__async"])(this, arguments, function*(file, name, options = DEFAULT_OPTIONS) {
        let schema;
        try {
            const { load } = yield __turbopack_context__.A("[project]/node_modules/.pnpm/js-yaml@4.1.1/node_modules/js-yaml/dist/js-yaml.mjs [app-rsc] (ecmascript, async loader)");
...
function compile(_0, _1) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$6FNC3XMI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["__async"])(this, arguments, function*(schema, name, compileOptions = {}) {
        var _a, _b, _c, _d, _e, _f;
        validateOptions(compileOptions);
        let options = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deepMerge"])({}, DEFAULT_OPTIONS, compileOptions);
        for (const plugin of options.plugins){
            options = (_b = yield (_a = plugin.config) == null ? void 0 : _a.call(plugin, options)) != null ? _b : options;
        }
        let input = {
            schema,
            schemaToId: options.schemaToId
        };
        for (const plugin of options.plugins){
            input = (_d = yield (_c = plugin.input) == null ? void 0 : _c.call(plugin, input)) != null ? _d : input;
        }
        const linked = {
            schema: link(input.schema),
            schemaToId: input.schemaToId
        };
        const errors = validate(linked, name);
        if (errors.length) {
            errors.forEach((_)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$fumari$2b$json$2d$schema$2d$to$2d$typescript$40$2$2e$0$2e$0$2f$node_modules$2f40$fumari$2f$json$2d$schema$2d$to$2d$typescript$2f$dist$2f$chunk$2d$HXIR7QLA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["error"])(_));
...
//# sourceMappingURL=7959d_%40fumari_json-schema-to-typescript_dist_d872ac28._.js.map