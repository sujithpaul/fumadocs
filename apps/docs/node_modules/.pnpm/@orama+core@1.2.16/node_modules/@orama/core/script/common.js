...
exports.TRAINING_SETS = exports.Client = exports.Auth = void 0;
...
class Client {
    ...
    async requestStream(req) {
        ...
        return response.body?.pipeThrough(new event_stream_js_1.EventsStreamTransformer());
    }
...
exports.TRAINING_SETS = ['query_optimizer', 'query_planner', 'query_filtering'];
