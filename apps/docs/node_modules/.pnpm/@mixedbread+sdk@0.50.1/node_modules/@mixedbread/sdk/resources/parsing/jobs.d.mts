...
export declare class Jobs extends APIResource {
     ...
     */
    poll(jobId: string, pollIntervalMs?: number, pollTimeoutMs?: number, options?: RequestOptions): Promise<ParsingJob>;
    /**
     ...
     * @returns The job object once it reaches a terminal state
     */
    createAndPoll(body: JobCreateParams, pollIntervalMs?: number, pollTimeoutMs?: number, options?: RequestOptions): Promise<ParsingJob>;
    /**
     ...
     * @returns The created parsing job
     */
    upload(file: Uploadable, body?: Omit<JobCreateParams, 'file_id'>, options?: RequestOptions): Promise<ParsingJob>;
    /**
