...
export declare namespace DataSource {
     ...
     */
    interface DataSourceAPIKeyParams {
        type?: 'api_key';
        /**
         * The API key
         */
...
export declare namespace NotionDataSource {
    /**
     * Base class for API key create or update parameters.
     */
    interface APIKeyCreateOrUpdateParams {
        type?: 'api_key';
        /**
         * The API key
         */
...
export type DataSourceCreateParams = DataSourceCreateParams.NotionDataSource | DataSourceCreateParams.LinearDataSource;
...
export type DataSourceUpdateParams = DataSourceUpdateParams.NotionDataSource | DataSourceUpdateParams.LinearDataSource;
