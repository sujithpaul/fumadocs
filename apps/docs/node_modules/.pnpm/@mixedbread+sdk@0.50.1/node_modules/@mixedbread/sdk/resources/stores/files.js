...
class Files extends resource_1.APIResource {
    ...
    retrieve(fileIdentifier, params, options) {
        ...
        return this._client.get((0, path_1.path) `/v1/stores/${store_identifier}/files/${fileIdentifier}`, {
            query,
            ...options,
        });
    }
    ...
    update(fileIdentifier, params, options) {
        ...
        return this._client.patch((0, path_1.path) `/v1/stores/${store_identifier}/files/${fileIdentifier}`, {
            body,
            ...options,
        });
    }
    ...
    delete(fileIdentifier, params, options) {
        ...
        return this._client.delete((0, path_1.path) `/v1/stores/${store_identifier}/files/${fileIdentifier}`, options);
    }
    /**
