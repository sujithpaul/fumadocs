...
exports.Cursor = exports.LimitOffset = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.MixedbreadError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
class LimitOffset extends AbstractPage {
    constructor(client, response, body, options) {
