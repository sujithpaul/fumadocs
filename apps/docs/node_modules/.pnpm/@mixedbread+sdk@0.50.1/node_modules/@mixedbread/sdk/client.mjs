...
var _Mixedbread_instances, _a, _Mixedbread_encoder, _Mixedbread_baseURLOverridden;
...
export class Mixedbread {
     ...
     */
    constructor({ baseURL = readEnv('MIXEDBREAD_BASE_URL'), apiKey = readEnv('MXBAI_API_KEY'), ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _Mixedbread_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Mixedbread_instances, "m", _Mixedbread_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Mixedbread_encoder, "f").call(this, { body, headers });
        }
    }
}
_a = Mixedbread, _Mixedbread_encoder = new WeakMap(), _Mixedbread_instances = new WeakSet(), _Mixedbread_baseURLOverridden = function _Mixedbread_baseURLOverridden() {
