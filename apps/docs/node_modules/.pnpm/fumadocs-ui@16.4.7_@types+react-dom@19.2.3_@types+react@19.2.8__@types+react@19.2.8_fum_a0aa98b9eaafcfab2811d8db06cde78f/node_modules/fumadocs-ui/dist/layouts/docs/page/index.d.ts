...
declare function EditOnGitHub(props: ComponentProps<'a'>): react_jsx_runtime75.JSX.Element;
/**
...
declare function DocsDescription({
  ...
  className,
  ...props
}: ComponentProps<'p'>): react_jsx_runtime75.JSX.Element | null;
declare function DocsTitle({
  children,
  className,
  ...props
}: ComponentProps<'h1'>): react_jsx_runtime75.JSX.Element;
//#endregion
