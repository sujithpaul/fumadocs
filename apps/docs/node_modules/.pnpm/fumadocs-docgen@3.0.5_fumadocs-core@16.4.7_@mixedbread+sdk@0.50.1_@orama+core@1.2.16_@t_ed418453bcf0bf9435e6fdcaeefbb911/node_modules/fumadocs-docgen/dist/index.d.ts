...
//#endregion
//#region src/file-generator.d.ts
...
declare function fileGenerator({
  relative,
  trim
}?: FileGeneratorOptions): DocGenerator;
//#endregion
//#region src/remark-install.d.ts
 ...
 */
declare function remarkInstall({
  Tab,
  Tabs,
  persist,
  packageManagers
...
//#endregion
//#region src/remark-show.d.ts
declare function remarkShow(options?: {
  variables?: Record<string, unknown>;
}): Transformer<Root, Root>;
//#endregion
export { DocGenerator, FileGeneratorInput, FileGeneratorOptions, RemarkDocGenOptions, RemarkInstallOptions, createElement, expressionToAttribute, fileGenerator, fileGeneratorSchema, remarkDocGen, remarkInstall, remarkShow };
