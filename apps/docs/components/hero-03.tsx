...
export default function Hero03() {
  return (
    <>
      {/* Main Hero Section */}
      <div className="relative min-h-screen w-full flex flex-col gap-12 md:gap-16 lg:gap-20 xl:gap-24 items-center justify-center px-6 py-16 overflow-hidden -mt-8 sm:-mt-12">
        {/* Background Image */}
        ...
        <div className="relative z-10 text-center max-w-4xl lg:max-w-5xl xl:max-w-6xl">
          {/* Animated badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 md:mb-8 bg-background/80 backdrop-blur-sm border border-border/50 rounded-full text-sm font-medium text-muted-foreground animate-[fadeInUp_0.6s_ease-out_both]">
          ...
          <p className="mt-6 md:mt-8 text-lg md:text-xl lg:text-2xl text-white text-balance max-w-3xl mx-auto leading-relaxed animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
            Leading practices have moved beyond generic EMRs to software built specifically for therapy workflows.
          </p>

          <div className="mt-10 lg:mt-12 flex items-center justify-center animate-[fadeInUp_0.6s_ease-out_0.3s_both]">
      ...
      <div className="relative w-full py-16 md:py-24 lg:py-32 px-6 bg-gradient-to-b from-muted via-muted to-background">
        <div className="max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-[1400px] mx-auto">
