      ...
      <div className="relative flex min-h-[600px] h-[70vh] max-h-[900px] border rounded-2xl overflow-hidden mx-auto w-full max-w-[1400px] bg-origin-border">
        ...
        <div className="flex flex-col z-2 px-4 size-full md:p-12 max-md:items-center max-md:text-center">
          ...
          <div className="flex flex-row items-center justify-center gap-4 flex-wrap w-fit">
            <Link href={`/${lang}/docs`} className={cn(buttonVariants(), 'max-sm:text-sm')}>
              Getting Started
            </Link>
            <a
...
function Feedback({ lang }: { lang: string }) {
  return (
    <>
      <div className={cn(cardVariants())}>
        ...
        <Link href={`/${lang}/showcase`} className={cn(buttonVariants())}>
          Showcase
        </Link>
      </div>
      <div
...
function ForEngineers({ lang }: { lang: string }) {
  return (
    <>
      <h2
        className={cn(
...
This is my first document.`}
      ...
      <div className={cn(cardVariants(), 'flex flex-col max-md:pb-0')}>
        ...
        <Link
          href={`/${lang}/docs/headless/search/algolia`}
      ...
      <div className={cn(cardVariants(), 'flex flex-col p-0 overflow-hidden')}>
        <div className="p-6 mb-2">
          ...
          <Link href={`/${lang}/docs/cli`} className={cn(buttonVariants({ className: 'w-fit' }))}>
            Commands
          </Link>
        </div>
...
function OpenSource({ lang }: { lang: string }) {
  return (
    <>
      <h2
        className={cn(
      ...
      <div className={cn(cardVariants({ className: 'flex flex-col' }))}>
        ...
        <div className="mb-8 flex flex-row items-center gap-2">
          <Link href={`/${lang}/sponsors`} className={cn(buttonVariants({ variant: 'primary' }))}>
            Sponsors
          </Link>
          <a
      ...
      >
        ...
        <li className="flex flex-row flex-wrap gap-2 mt-auto">
          <Link href={`/${lang}/docs`} className={cn(buttonVariants())}>
            Read docs
          </Link>
          <a
